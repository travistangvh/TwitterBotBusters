...
class homo_Trainer:
    def __init__(
        ...
        if num_hidden_layers == 1:
            self.model = GNN_classifier_1_layer(input_dim, 2, hidden_dim, activation, aggr)
        elif num_hidden_layers == 2:
            self.model = GNN_classifier(input_dim, 2, hidden_dim, activation, aggr)
        elif num_hidden_layers == 3:
            self.model = GNN_classifier_3_layer(input_dim, 2, hidden_dim, activation, aggr)
        elif num_hidden_layers == 4:
            self.model = GNN_classifier_4_layer(input_dim, 2, hidden_dim, activation, aggr)
        elif num_hidden_layers == 5:
            self.model = GNN_classifier_5_layer(input_dim, 2, hidden_dim, activation, aggr)
        elif num_hidden_layers == 6:
            self.model = GNN_classifier_6_layer(input_dim, 2, hidden_dim, activation, aggr)
        elif num_hidden_layers == 7:
            self.model = GNN_classifier_7_layer(input_dim, 2, hidden_dim, activation, aggr)
        elif num_hidden_layers == 8:
            self.model = GNN_classifier_8_layer(input_dim, 2, hidden_dim, activation, aggr)
